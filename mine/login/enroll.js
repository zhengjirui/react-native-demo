        ...
        return (
            <View style={styles.container}>
                ...
                <PullToRefreshScrollView
                    ...
                    <Header
                        renderTitle = { () => {
                            return <Text style={styles.baise}>新用户注册</Text>
                        }}
                        renderRight = { () => {
                            return <Text style={styles.headerRight}>已有账号</Text>
                        }}
                    />
                    ...
                    <View>
                        ...
                        <View style={styles.forgetbox}>
                            ...
                            <View style={this.is_selected ? 'styles.xuan' : 'styles.meixuan' }
                                  onClick={ () => { this.is_selected = !this.is_selected } }></View>
